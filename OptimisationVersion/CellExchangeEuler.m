function [ParallelString] = CellExchangeEuler(ParallelString,I_func,ParallelCells,CurrentModifier)
...
NewVP1 = Euler_step(CurrentVp1, I_func, ParallelString.Rp1, ParallelString.Cp1, t_current,CurrentModifier);
NewVP2 = Euler_step(CurrentVp2, I_func, ParallelString.Rp2, ParallelString.Cp2, t_current,CurrentModifier);
