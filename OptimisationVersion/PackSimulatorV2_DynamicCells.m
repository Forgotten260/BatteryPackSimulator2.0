...
SavingDensity = 5;
BalancingEnabled =1;
BalancingEveryPeriod = round(2/timestep); % Balance every x seconds but values adjusted for timestep and rounded to make integer
OutputItterEveryNumber = 10000;
...
ResistanceStdDev = 0.06;  % Units in %
