...
plot(DeltaData.A_1_5.Bal,Color= [0.85, 0.33, 0.10],LineWidth=1.5, LineStyle="-",Marker="o")
plot(DeltaData.A_1_5.NonBal,Color= [0.85, 0.33, 0.10],LineWidth=1.5, LineStyle="-.",Marker="o")
